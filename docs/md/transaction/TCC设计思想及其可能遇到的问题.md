...
![请添加图片描述](https://img-blog.csdnimg.cn/bca51812a4bf49b89a32c2f63534e3a5.jpg?)
发现网上的一个关于TCC的分享很赞，转载一下。

原文地址：https://www.sofastack.tech/blog/sofa-channel-4-retrospect/
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/fe77f27a71e24302988c67e983f92222.png?)
...
1. 业务拆分。根据功能对数据进行分组，并将不同的微服务分布在多个不同的数据库上，这实际上就是 SOA 架构下的服务化。业务拆分就是把业务逻辑从一个单系统拆分到多个微服务中。

2. 数据分片。在微服务内部将数据拆分到多个数据库上，为横向扩展增加一个新的维度。数据分片就是把一个微服务下的单个 DB 拆分成多个 DB，具备一个 Sharding 的功能。通过这样的拆解，相当于一种资源的横向扩展，从而使得整个架构可以承载更高的吞吐。
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/190241ecbc844b0e98af33d913540c11.png?)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/118532b4e728458d9bd3115a03355c08.png?)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/83d7ea02b0e9451b98c5081df4dc7ff3.png?)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/832589341490439c8c8dded23e337393.png?)
...
![异常控制-空回滚](https://img-blog.csdnimg.cn/af34b5d2670142e282e46795d10349ef.png?)
...
![异常控制-幂等](https://img-blog.csdnimg.cn/8f9304a77329462cbdc824dea88d8d74.png?)
...
![异常控制-事物控制表](https://img-blog.csdnimg.cn/0430ace4901849f4b265a29591054841.png?)
...
![幻异常控制-Try 方法](https://img-blog.csdnimg.cn/fe3eaf06c3074e5f954a6a4e36817269.png?)
...
![极致性能提升-同库模式](https://img-blog.csdnimg.cn/cd0cef4d97174460b9837e2e05a69b26.png?)
...
![极致性能提升-同库模式优化对比](https://img-blog.csdnimg.cn/cb621f77467d4fc0910295ea4defb682.png?)
